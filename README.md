...
curl --request POST --url https://api.apimart.ai/v1/images/generations \
  ...
  --data '{"model":"gpt-image-2.5-ext","prompt":"a modern cliffside villa at dusk, slow camera push","size":"16:9","n":1}'
```
...
| `model` not found | wrong id or wrong tier field | copy the exact id `gpt-image-2.5-ext` (alias `gptimage2.5`) from the table above |
